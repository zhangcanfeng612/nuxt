  ...
  <div class="business-plan">
    ...
    <div class="tabList">
      <ul>
        ...
        <nuxt-link :to="{path: '/template'}" class="active"><li>商业计划书范文</li></nuxt-link>
        <nuxt-link :to="{path: '/template'}"><li>行业研究报告</li></nuxt-link>
      </ul>
    </div>
...
<script>
  ...
  export default {
    ...
    async asyncData (context) {
      ...
      // 获取应用场景
      function getLabels () {
        const url = `${$Server.api}/business_plan/label`;
        const params = {};
      ...
      // 获取范文
      function getslides () {
        const url = `${$Server.api}/business_plan`;
        const params = {
          label: activeLabel
        };
        return $Server.get(url, params);
